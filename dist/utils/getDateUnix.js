...
var getDateUnix = function getDateUnix(_ref) {
  ...
  return isJalaali ? (0, _momentJalaali.default)("".concat(year, "-").concat(month, "-").concat(day), JALAALI_DATE_FORMAT).unix() : (0, _momentJalaali.default)("".concat(year, "-").concat(month, "-").concat(day), GEORGIAN_DATE_FORMAT).unix();
};

var _default = getDateUnix;
