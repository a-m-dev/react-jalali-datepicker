...
var computeGeorgianDaysInRange = function computeGeorgianDaysInRange(_ref) {
  var _startDate = _ref._startDate,
      _stopDate = _ref._stopDate,
      defaultExcludedDays = _ref.defaultExcludedDays;
  var resultDays = {};
  var GEORGIAN_DATE_FORMAT = _Constants.DATE_FORMATS.GEORGIAN_DATE_FORMAT;
  ...
  var _loop = function _loop() {
    var _currDay$format$split = currDay.format(GEORGIAN_DATE_FORMAT).split("-").map(function (el) {
      return Number(el);
    }),
...
var _default = computeGeorgianDaysInRange;
